...
public class VideoPlayFragment extends BaseFragment {
    ...
    public void initViewProperty() {
        ...
        mWebView.addJavascriptInterface(new PlayeJavaScriptInterface(), "tlc_play");
            ...
            mHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    String js = "javascript: var v=document.getElementsByTagName('video')[0]; "
                            + "v.addEventListener('playing', function() { window.tlc_play.onStartPlay(); }, true); ";
                    view.loadUrl(js);
    ...
    private final class PlayeJavaScriptInterface{
        ...
        public void onStartPlay(){
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    UtilsToast.showLong(getContext(), "视频开始播放...");
        ...
        public void onStopPlay(){
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    UtilsToast.showLong(getContext(), "视频结束...");
                }
            });
        }
    }
