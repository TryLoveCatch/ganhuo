...
public class VideoPresenter extends BaseRecyclePresenter<IRecyclerBaseView> {
    ...
    public void loadData(boolean pIsForceRefresh, int pPage, int pPageSize) {
        ...
        ApiRetrofit.getInstance().get(ApiServeces.class).getDataByType(pPage, pPageSize, ApiServeces.TYPE_VIDEO)
